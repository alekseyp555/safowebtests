...
public class HierarchyLimitTests extends TestBase {
    ...
    public void выбрать_Иерархия_лимитов() throws Throwable {
        app.driver.findElement(By.id("ext-comp-1062")).click(); //Клик на иерархия лимитов
    ...
    public void загрузились_свойства_лимитов_Общие_дополнительно() throws Throwable {
        ...
        app.driver.findElement(By.cssSelector("tbody[class*=x-tree-node]:nth-of-type(6)")); //клик CSS на 6й элемент "ГСЗ Роснефть"
        app.driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        Thread.sleep(5000);
    }
}
